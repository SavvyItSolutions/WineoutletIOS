...
namespace WineHangoutz
{
    public class ServiceWrapper
    {
        ...
        public string ServiceURL
        {
            get
			{
				string development = "https://wineoutletdev.azurewebsites.net/";
                string current = "https://hangoutz.azurewebsites.net/";
				string production = "https://wineoutlet.azurewebsites.net/";
				return current + "api/Item/";
            }
		}
        ...
        public async Task<int> UpdateCustomer(Customer customer)
        {
			...
			sw.Stop();
			LoggingClass.LogServiceInfo("Service "+sw.Elapsed.TotalSeconds, "Update Customer");
        ...
        public async Task<ItemListResponse> GetItemFavsUID(int userId)
        {
			...
			sw.Stop();
			LoggingClass.LogServiceInfo("Service "+sw.Elapsed.TotalSeconds, "Get ");
        ...
        public async Task<TastingListResponse> GetMyTastingsList(int customerid)
        {
			...
			{
				//customerid = 38691;
				var uri = new Uri(ServiceURL + "GetMyTastingsList/" + customerid);//+"/cardnumber/"+CurrentUser.GetCardNumber());
				var response = await client.GetStringAsync(uri).ConfigureAwait(false);
			...
			sw.Stop();
			LoggingClass.LogServiceInfo("Service "+sw.Elapsed.TotalSeconds, "GetMyTastings ");
		...
		public async Task<CustomerResponse> UpdateMail(string email,string userid)
		{
			...
			sw.Stop();
			LoggingClass.LogServiceInfo(userid+"user updated Service,"+email,"update Email Service,");
			LoggingClass.LogServiceInfo("Service " + sw.Elapsed.TotalSeconds, "update Email Service,");
			return output;
		}
