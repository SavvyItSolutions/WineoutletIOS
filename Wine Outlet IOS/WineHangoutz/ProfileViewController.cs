...
namespace WineHangoutz
{
...

	{
		...
		{ 
			UILabel lbl = new UILabel(new RectangleF(0, 0, 40f, 20f)); 
			lbl.TextColor = UIColor.Black; 
			lbl.Font = UIFont.SystemFontOfSize(12f); 
			lbl.TextAlignment = UITextAlignment.Center; 
			lbl.Font=UIFont.FromName("HelveticaNeue", 12f);
			lbl.Text = Items.ToArray()[row];
			return lbl; 
		}
	...
	public class StorePickerDataModel : UIPickerViewModel
	{
		...
		public override UIView GetView(UIPickerView pickerView, nint row, nint component, UIView view)
		{
			UILabel lbl = new UILabel(new RectangleF(0, 0, 120f, 40f));
			lbl.TextColor = UIColor.Black;
			lbl.Font = UIFont.SystemFontOfSize(12f);
			lbl.TextAlignment = UITextAlignment.Center;
			lbl.Font = UIFont.FromName("HelveticaNeue", 12f);
